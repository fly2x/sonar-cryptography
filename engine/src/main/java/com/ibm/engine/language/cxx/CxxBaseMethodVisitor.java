...
/**
 * Base method visitor for C/C++ that delegates to the detection engine to scan function bodies for
 * cryptographic API calls.
 */
public final class CxxBaseMethodVisitor implements IBaseMethodVisitor<AstNode> {
    ...
    public void visitMethodDefinition(@Nonnull AstNode method) {
        // Run the detection engine on the method body (function definition node)
