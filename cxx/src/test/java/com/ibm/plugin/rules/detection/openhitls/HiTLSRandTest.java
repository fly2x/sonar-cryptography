...
class HiTLSRandTest extends CxxTestBase {

    public HiTLSRandTest() {
        super(HiTLSRand.rules());
    }

    @Test
    void testDetectionRulesNotEmpty() {
        assertThat(HiTLSRand.rules()).isNotEmpty();
        assertThat(HiTLSRand.rules()).hasSize(1);
    }

    @Test
    void testRandRulesInAggregation() {
        assertThat(HiTLSDetectionRules.rules()).containsAll(HiTLSRand.rules());
    }
