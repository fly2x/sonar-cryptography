...
public class CxxTranslator
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CxxTranslator.class);
    ...
    public Optional<INode> translate(
        ...
        LOGGER.debug(
                "[DIAG] CxxTranslator.translate: valueType={}, value='{}', context={}, file={}",
                value.getClass().getSimpleName(),
                value.asString(),
                detectionValueContext.getClass().getSimpleName(),
                filePath);
        DetectionLocation detectionLocation =
                getDetectionContextFrom(value.getLocation(), bundleIdentifier, filePath);
        if (detectionLocation == null) {
            LOGGER.debug("[DIAG]   detectionLocation is null, returning empty");
