...
/** Translates C/C++ Protocol detection values to TLS/DTLS model nodes. */
    ...
    public @Nonnull Optional<INode> translate(
        ...
        if (value instanceof ValueAction<AstNode>) {
            ...
            return switch (val.toUpperCase().trim()) {
                ...
                case "DTLS" -> Optional.of(new TLS(detectionLocation));
                case "HITLS" -> Optional.of(new TLS(detectionLocation));
